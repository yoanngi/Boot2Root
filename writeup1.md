...
'p\xf6\xff\xbf' 
```
Le shellcode quand a lui est un code tous fait que l'on trouve facilement sur le net. C'est d'ailleur le meme que Hackndo dans son super tutoriel sur le BOF (https://beta.hackndo.com/buffer-overflow/).
